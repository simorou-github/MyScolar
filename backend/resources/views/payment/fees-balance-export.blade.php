...
<body style="font-family: 'Gill Sans', sans-serif;">
  <style type="text/css">
    ...
    <div style="width: 100%; font-family: 'Gill Sans', sans-serif;  margin-top: 25px !important; margin-bottom: 5px;">
      <div style="display: inline-block; height: 50px; width: 20%; text-align: center; padding-top: 1px; background: #f8f8fb; border: solid 2px #cadaec;">
      ...
      <div style="margin-left: 3px; display: inline-block; height: 50px;  width: 18%; text-align: center; padding-top: 1px; background: #f8f8fb; border: solid 2px #cadaec;">
      ...
      <div style="margin-left: 3px; display: inline-block;  height: 50px; width: 19%; text-align: center; padding-top: 1px; background: #f8f8fb; border: solid 2px #cadaec;">
      ...
      <div style="margin-left: 3px; display: inline-block;  height: 50px; width: 20%; text-align: center; padding-top: 1px; background: #f8f8fb; border: solid 2px #cadaec;">
    ...
    <div style="margin-top: -10px;" >
        <table style="border: solid 1px #dee2e6; font-family: 'Gill Sans', sans-serif; font: size 12px;" width="100%">
            <thead>
            <tr style="height: 35px; border: solid 1px #dee2e6; background: #f8f8fb; font-size: 12px;">
                ...
                <!-- <th style="height: 35px; border: solid 1px #dee2e6;">PRENOMS</th> -->
                <th style="height: 35px; border: solid 1px #dee2e6;">CLASSE</th>
                <!-- <th style="height: 35px; border: solid 1px #dee2e6;">TELEPHONE</th>
                <th style="height: 35px; border: solid 1px #dee2e6;">DATE DE NAISSANCE</th>
                <th style="height: 35px; border: solid 1px #dee2e6;">MATRICULE</th>
                <th style="height: 35px; border: solid 1px #dee2e6;">EMAIL</th>
                <th style="height: 35px; border: solid 1px #dee2e6;">IFU ECOLES</th> -->
                ...
                <!-- <th style="height: 35px; border: solid 1px #dee2e6;">REPARTITION</th> -->
            ...
            <tr style="border: solid 1px #dee2e6; font-size: 11px;">
                ...
                <!-- <td style="border: solid 1px #dee2e6; padding: 1px;">{{$balance->student_first_name}}</td> -->
                <td style="border: solid 1px #dee2e6; padding: 1px;">{{$balance->classe_code.'-'.$balance->groupe_code}}</td>
                <!-- <td style="border: solid 1px #dee2e6; padding: 1px;">{{$balance->student_phone}}</td>
                <td style="border: solid 1px #dee2e6; padding: 1px;">{{$balance->student_birthday}}</td>
                <td style="border: solid 1px #dee2e6; padding: 1px;">{{$balance->student_matricule}}</td>
                <td style="border: solid 1px #dee2e6; padding: 1px;">{{$balance->student_email}}</td>
                <td style="border: solid 1px #dee2e6; padding: 1px;">{{$balance->ifu}}</td> -->
                ...
                <!-- <td style="height: 35px; border: solid 1px #dee2e6;">{{$balance->fees_label}}</td> -->
