...

    {
        ...
        subItems: [
            ...
            },
            {
                ...
                parentId: 4,
                rolesAllowed: ['school-admin', 'accountant']
            },
            {
                id: 4003,
        ...
        subItems: [
            {
                ...
                parentId: 6,
                rolesAllowed: ['super-admin'] // Exemple: seuls les super admins peuvent voir ce lien
            },
        ]
    },

    {
        ...
        subItems: [
            ...
            },
            {
                ...
                parentId: 7,
                rolesAllowed: ['super-admin'] // Exemple: seuls les super admins peuvent gérer les permissions
            }
        ]
    },
